...
namespace Ch24ShoppingCartMVC.Models
{
    public class CartModel
    {
        ...
        public CartViewModel GetCart(string id = "")
        {
            ...
            //List<ProductModelView> store = new List<ProductModelView> ();
        ...
        public void AddToCart(CartViewModel model)
        {
            if (model.AddedProduct.ProductID != null)
            {
                ...
                ProductViewModel inCart = model.Cart.Find(p => p.ProductID == id);
            ...
            }//end ProductID check if statement
        }//end AddToCart
