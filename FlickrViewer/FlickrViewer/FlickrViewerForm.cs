...
namespace FlickrViewer
{
   public partial class FlickrViewerForm : Form
   {
      ...
      // http://www.flickr.com/services/apps/create/apply
       private const string KEY = "713c965dc40b735e1756898e94aa23de";
      ...
      // display results when query completes (**use async)
      private async void searchButton_Click( object sender, EventArgs e )
      {
        ...
        //privacy_filter=1. Use the inputTextBox.Text.Replace(" ", ",") for tag.
          ...
          //need to figure out filter later
         var flickrURL = string.Format("https://www.flickr.com/services/rest/?method=flickr.photos.getrecent&tag_mode=all&per_page=100&privacy_filter=1&api_key=713c965dc40b735e1756898e94aa23de&tag=" + inputTextBox.Text.Replace(" ", ","));
         ...
         try
         {
            ...
            // await fickrTask then parse results with XML Document (XDocument)
            ...
            var flickrPhotos =
               ...
               select new FlickrResult //stores all the attributes to make a new object called FlickrResult
               {
         ...
         object sender, EventArgs e )
      {
         if ( imagesListBox.SelectedItem != null )
         {
           ...
           WebClient imageListBoxClient = new WebClient();
            //Invoke the the WeClient DownloadDataTaskAsync method to get byte array called imageBytes that contains the photo (from selectedURL) and await the results. 
               ...
               byte [] imageBytes = await imageListBoxClient.DownloadDataTaskAsync(selectedURL);
